    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="gameplay-steps">
                ...
                <div class="step">
                    <div class="step-number">2. Получайте карты через gacha-систему</div>
                </div>
                <div class="step">
                    <div class="step-number">3. Составляйте колоду из 5 заклинаний</div>  
                </div>
                <div class="step">
                    <div class="step-number">4. Сражайтесь в платформере против врагов</div>
                </div>
            </div>
        </section>
        <section>
